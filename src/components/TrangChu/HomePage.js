    ...
    return (
        <div className="content-wrapper">
            ...
            <div className='content-2'>
                ...
                <div className="logo-meaning-wrapper">
                    <div className="logo-meaning">
                        <h2 className="logo-meaning-title">Ý NGHĨA LOGO HỌC VIỆN</h2>
                        <img className="logo-meaning-img" src="https://portal.ptit.edu.vn/wp-content/uploads/2016/06/ptitlogo72.gif" alt='portal' />
                    </div>
                    <div className="text-meaning">
                        <h3 className="text-meaning-title">Hình khối của logo</h3>
                        ...
                        <p className="text-meaning-content">Ba vòng tròn quyện vào nhau và chuyển hóa sang nhau thể hiện 3 gắn kết: Đào tạo – Nghiên cứu – Sản xuất Kinh doanh.</p>
                        <p className="text-meaning-content">Hình ảnh quyển sách mở rộng và mô hình cấu trúc nguyên tử: biểu tượng 2 hoạt động chính của Học viện là đào tạo và nghiên cứu</p>
                        <p className="text-meaning-content">Chữ PTIT (tên viết tắt tiếng Anh của Học viện – Posts & Telecoms Institute of Technology) đồng thời là Bưu chính (P), Viễn thông (T) và Công nghệ thông tin (IT) – 3 lĩnh vực nghiên cứu và đào tạo của Học viện</p>
                        <h3 className="text-meaning-title">Màu sắc logo</h3>
                        <p className="text-meaning-content">Logo Học viện lấy màu đỏ làm chủ đạo và ngôi sao vàng biểu trưng cho cờ Tổ quốc Việt Nam.</p>
                    </div>
                </div>


                <div className="more-info">
                    <h3 className="info-title">HỌC VIỆN CÔNG NGHỆ BƯU CHÍNH VIỄN THÔNG</h3>
