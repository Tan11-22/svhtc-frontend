...
import { xoaMonHoc } from '../../services/monHocService';
function FormDeleteMonHoc({open, onClose, maMH, refresh}) {
    const [thongTin, setThongTin] = useState('');
    
    useEffect (
        () => {
            if(maMH !== ""){
                setThongTin("Bạn muốn xoá môn học " + maMH + " ?")
            }
...
export default FormDeleteMonHoc
